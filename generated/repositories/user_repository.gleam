...
pub fn update_user_partial(
  ...
  case updates {
    [] -> 
      ...
      user_query.find_by_id(conn, pog.text(id)) 
    ...
    _ -> user_query.update_partial(conn, pog.text(id), updates)
  }
}
...
pub fn delete_user(conn: Connection, id: String) -> Result(Int, QueryError) {
  user_query.delete(conn, pog.text(id))
}